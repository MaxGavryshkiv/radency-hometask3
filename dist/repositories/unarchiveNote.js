...
const unarchiveNote = (noteId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (index !== -1) {
        ...
        yield promises_1.default.writeFile(path_1.default.join(__dirname, "../json/archiveNotes.json"), JSON.stringify(archiveNotes));
        notes.push(noteById);
...
//# sourceMappingURL=unarchiveNote.js.map